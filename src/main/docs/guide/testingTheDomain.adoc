...
[source,groovy]
./src/test/groovy/demo/domain/MakeSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/domain/MakeSpec.groovy[]
----

[source,groovy]
./src/test/groovy/demo/domain/ModelSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/domain/ModelSpec.groovy[]
----

[source,groovy]
./src/test/groovy/demo/domain/DriverSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/domain/DriverSpec.groovy[]
----
...
from the top level project directory (`cd initial`).
