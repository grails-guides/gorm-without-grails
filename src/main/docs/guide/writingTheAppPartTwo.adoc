...
lets expand that to a full application and see how to finish connection everything up.
...
a `src/main/resources/application.properties`. Lets go ahead and add some options in there.
